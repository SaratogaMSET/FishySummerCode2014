...
public class AngledPickUpSubsystem extends Subsystem {
    ...
    public boolean isPickUpRetracted() {
        ...
        //should also have Limit Switch here as the primiary check
        return(leftPiston.get() == LEFT_PISTON_RETRACTED_STATE && rightPiston.get() == RIGHT_PISTON_RETRACTED_STATE);
